...
export const FormBuyer: ComponentType<Iform> = ({
  handleSubmit,
  form,
  submitting,
  pristine,
  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      ...
      />
      <label>
        <Field name="personal_data" component="input" type="checkbox" />Я
        согласен на обработку персональных данных
      </label>
      <label>
        <Field name="mailing_of_letters" component="input" type="checkbox" />
