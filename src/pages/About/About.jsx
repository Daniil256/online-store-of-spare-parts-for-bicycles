    ...
    return (
        <div className="about content pink">
            ...
            <ul className="block__social">
                <li className="social social__1"><img className="img_social" src="./icons/facbook.png" alt="social" /></li>
                <li className="social social__2"><img className="img_social" src="./icons/google.png" alt="social" /></li>
                <li className="social social__3"><img className="img_social" src="./icons/inst.png" alt="social" /></li>
                <li className="social social__4"><img className="img_social" src="./icons/teleg.png" alt="social" /></li>
                <li className="social social__5"><img className="img_social" src="./icons/vk.png" alt="social" /></li>
                <li className="social social__6"><img className="img_social" src="./icons/youtube.png" alt="social" /></li>
            </ul>
