...
const ProductPage = ({ onAddInCart, products, onRemoveInCart, onOrdering }) => {
    ...
    let item = products.productList.find(unit => unit.id === Number(id))

    if (!item) {
        item = JSON.parse(localStorage.getItem('ProductPage'))
    }
        ...
        <div className="ProductPage row content">
            ...
            <div className="column image">
                ...
                <div className="block green-black">
                    ...
                    <ol>
                        ...
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut, expedita?</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias, a repudiandae!</li>
                    </ol>
                </div>
            ...
            <div className="row">
                ...
                <div className="block red">
                    <h4>Описание</h4>
                    <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptates repellendus nihil fuga aut facere quos quod earum minima eos id nobis ducimus minus, et consectetur perferendis, ipsum accusamus, vero inventore?</p>
                    <p>Ipsum dolor sit, amet consectetur adipisicing elit. Quo, asperiores molestias iure sunt corporis molestiae vero maxime minus fuga unde!</p>
                </div>
                <div className="block yellow cost">
                    <span>{(item.cost * item.numberOfGoods).toLocaleString()}  &#8381;</span>
                    <span className="old_cost">{Math.ceil(item.cost * 1.3 * item.numberOfGoods).toLocaleString()}  &#8381;</span>
                    <p>* за {item.numberOfGoods}
                        {item.numberOfGoods === 1 ? ' единицу '
                            : item.numberOfGoods > 4 ? ' единиц '
                                : item.numberOfGoods > 1 ? ' единицы ' : ''
                        }
                        товара</p>
                </div>
                {item.limited
                    ...
                    <div className="block green-blue">
                        <span>Количество этого товара ограничено, и скоро он уйдет с продажи</span>
                    </div>
                }
                ...
                <div className="block green-blue">
                    ...
                    <ul>
                        ...
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing.</li>
                        <li>Lorem ipsum dolor sit amet consectetur.</li>
                        <li>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dignissimos, numquam?</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero similique delectus recusandae!</li>
                        <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat!</li>
                        <li>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nisi enim quo ducimus consequatur placeat odio?</li>
                    </ul>
                </div>
